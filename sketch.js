...
function draw() {
  ...
  if(gameState ==="end"){ 
    background(0);
    fill('red');
    text('GO AGAIN TO SAVE THE EARTH', 500,500);
...
function EduCollection(){
  if (frameCount%50===0 && gameState=="level1"&& gameState2 === 0){
    var pencil = createSprite(random(400, windowWidth-600), random(problem.y, windowHeight), 100, 100);
    pencil.velocityX = 6;
    pencil.lifetime=500;
